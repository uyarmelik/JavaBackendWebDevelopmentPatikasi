# Java ile Backend Web Development Patikası: Object Oriented Programming
Bu repo [Patika](https://app.patika.dev/) sitesindeki [Java ile Backend Web Development](https://app.patika.dev/egitimler/java-ile-backend-web-development-patikasi) patikasının [Object Oriented Programming](https://app.patika.dev/moduller/oop) eğitiminin ödev kodlarını ve bitirme projelerini içermektedir.
